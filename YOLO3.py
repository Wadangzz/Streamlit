...
class Vision():
    ...
    def __init__(self):
        ...
        model_cfg = "C:/Users/user/Documents/GitHub/darknet-master/cfg/yolov3.cfg"
        model_weights = "C:/Users/user/Documents/GitHub/darknet-master/yolov3.weights"
        ...
        # # List Comprehension
        with open("C:/Users/user/Documents/GitHub/darknet-master/data/coco.names", "r") as f: # 파일 열기 r = 읽기 모드
...
# 비디오 캡쳐 또는 이미지 읽기
cap = cv2.VideoCapture(0) # 또는 cv2.imread("image.jpg") 비디오 채널 0번번
